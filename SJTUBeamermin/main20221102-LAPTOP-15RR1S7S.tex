...
% \renewtheorem{lemma}[section]{Lemma}
...
\begin{document}
 ...
 %   \subtitle{SJTUBeamer \fbox{\textsc{min}} Template}         % 副标题
    \author{Zhaole Li}                  % 作者
    \date{\textcolor{red}{2022/11/2}}                          % 日期
    \maketitle                             % 创建标题页
...
%\subsection{第 1 小节}
    ...
    \begin{frame}
        ...
        \begin{definition}[Trace Function]
...
% \section{The third-order of the simplest  \mathcal{PS}  bent functions}
    ...
    \begin{frame}
        \frametitle{The partition of $ \alpha,\beta $-\Romannum{1}}
        \begin{figure}
    ...
    \begin{frame}
        \frametitle{The partition of $ \alpha,\beta $-\Romannum{2}}
        \begin{figure}
            \caption{The partition of $ \alpha,\beta $}
            \begin{center}
                \begin{tikzpicture}[node distance=0.8cm, scale=0.9]
    ...
    \begin{frame}
        \frametitle{The partition of $ \alpha,\beta$-\Romannum{3} }
        \begin{figure}
            \caption{The partition of $ \alpha,\beta $}
            \begin{center}
